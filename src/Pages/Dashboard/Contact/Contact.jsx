...
const Contact = () => {
  return (
    <div>
      <h2 className="text-center text-2xl font-bold mt-2">contact us if necessary</h2>
      <div className=" items-center">
        ...
        <div className="flex gap-6 justify-center items-center mb-4 md:mb-1 text-[#afafaf] text-center text-xl ">
          <p> <a href="#"
